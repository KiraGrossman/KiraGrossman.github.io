...
9. Coat the device with parylene-C using a parylene deposition machine so that the acrylates from the resin do not leak into the device. A thin layer is desired (only one coat). 
