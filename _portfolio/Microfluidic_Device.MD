...
* **Calculations**
  ...
  2. Flow Rate
      ...
      c. Determination of Flow Rates
        ...
        Desired ratio of flow rates based on literature: $1Q_{particles}:6Q_{water}$

        $Q_{particles}=\frac{\frac{V}{7}}{10s}\times \frac{60  min}{1  s} = 0.521 mL/min$

        $Q_{water}=\frac{\frac{V\times 6}{7}}{10s}\times \frac{60  min}{1  s} = 3.16 mL/min$
