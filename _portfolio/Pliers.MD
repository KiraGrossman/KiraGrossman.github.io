...
| ----------- | ----------- | ----------- |
| Handle and Nose | * The Handle/Nose's shape and size was created to mimic that of manufactured pliers. 
* The Inner Handle Diameter rotates the Handle/Nose around the Secure, allowing for the pinching capability. 
